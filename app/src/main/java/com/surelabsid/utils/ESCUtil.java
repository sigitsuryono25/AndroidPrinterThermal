...
public class ESCUtil {
	...
	public static byte[] getPrintQRCode2(String data, int size){
		...
		byte[] bytes2 = com.sunmi.printerhelper.utils.BytesUtil.getZXingQRCode(data, size);
		return com.sunmi.printerhelper.utils.BytesUtil.byteMerger(bytes1, bytes2);
	}
	...
	public static byte[] getPrintBarCode(String data, int symbology, int height, int width, int textposition){
		...
		try{
			...
			byte[] barcode;
			if(symbology == 10){
				barcode = com.sunmi.printerhelper.utils.BytesUtil.getBytesFromDecString(data);
			}else{
	...
	public static byte[] printBitmap(Bitmap bitmap){
		...
		byte[] bytes2 = com.sunmi.printerhelper.utils.BytesUtil.getBytesFromBitMap(bitmap);
		return com.sunmi.printerhelper.utils.BytesUtil.byteMerger(bytes1, bytes2);
	}
	...
	public static byte[] printBitmap(byte[] bytes){
		...
		return com.sunmi.printerhelper.utils.BytesUtil.byteMerger(bytes1, bytes);
	}
	...
	*	需要设置1B 33 00将行间距设为0
	...
	public static byte[] selectBitmap(Bitmap bitmap, int mode){
		return com.sunmi.printerhelper.utils.BytesUtil.byteMerger(com.sunmi.printerhelper.utils.BytesUtil.byteMerger(new byte[]{0x1B, 0x33, 0x00},
				com.sunmi.printerhelper.utils.BytesUtil.getBytesFromBitMap(bitmap, mode)), new byte[]{0x0A, 0x1B, 0x32});
	}
